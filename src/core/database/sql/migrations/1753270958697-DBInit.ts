...
export class DBInit1753270958697 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "records" ("user_id" uuid NOT NULL, "event_id" uuid NOT NULL, "finishTime" integer NOT NULL, "role" "public"."records_role_enum" NOT NULL, "badge" json, CONSTRAINT "PK_133d4aa524e0ee2f1fe5aafefb6" PRIMARY KEY ("user_id", "event_id"))`);
        await queryRunner.query(`CREATE TABLE "events" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "date" TIMESTAMP NOT NULL, "description" text NOT NULL, "location_id" uuid, CONSTRAINT "UQ_dfa3d03bef3f90f650fd138fb38" UNIQUE ("name"), CONSTRAINT "PK_40731c7151fe4be3116e45ddf73" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "location_contacts" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "contactName" character varying NOT NULL, "contactEmail" character varying NOT NULL, "contactHotline" character varying NOT NULL, CONSTRAINT "PK_978e5adb29f49f2bcc3e887caee" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "location_details" ("location_id" uuid NOT NULL, CONSTRAINT "PK_bc3d33c9c8b950641be6cb7a147" PRIMARY KEY ("location_id"))`);
        await queryRunner.query(`CREATE TABLE "regions" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, CONSTRAINT "UQ_1eb9a8899a7db89f6ba473fd847" UNIQUE ("name"), CONSTRAINT "PK_4fcd12ed6a046276e2deb08801c" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "donations" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "amount" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL, "location_id" uuid, CONSTRAINT "PK_c01355d6f6f50fc6d1b4a946abf" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "records" ADD CONSTRAINT "FK_b66e8a730109a0d7bdbaa4828b0" FOREIGN KEY ("event_id") REFERENCES "events"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "location_details" ADD CONSTRAINT "FK_bc3d33c9c8b950641be6cb7a147" FOREIGN KEY ("location_id") REFERENCES "locations"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "locations" ADD CONSTRAINT "FK_0a0b8e70186ad9f217aada283ad" FOREIGN KEY ("region_id") REFERENCES "regions"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "donations" ADD CONSTRAINT "FK_5f99e56a11722ef3f0885308ed2" FOREIGN KEY ("location_id") REFERENCES "locations"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
